...
<article>
	...
	<form id="join" method="post" name="contractFrm">
		언제나 새로운 즐거움이 가득한 Shoes Shop의 회원가입 페이지입니다. <br> Shoes Shop의 회원가입은
		무료이며 회원님의 개인 정보는 '정보통신망이용촉진 및 정보보호 등에 관한 법률'에 의해 회원님의 동의 없이 제 3자에게
		제공되지 않으며, 철저히 보호되고 있사오니 안심하고 이용하시기 바랍니다. <br> <br>
...
(3) 서비스 이용으로 발생한 분쟁에 대해 소송이 제기되는 경우 회사의 본사 소재지를 관할하는 법원을 관할 법원으로 합니다.
		...
		<div style="text-align: center">
			<input type="radio" name="okon"> 동의함 &nbsp;&nbsp;&nbsp; <input
				type="radio" name="okon" checked> 동의하지 않음
