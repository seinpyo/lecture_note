...
CREATE TABLE RENTLIST(
	...
	BOOKNUM NUMBER(6) NOT NULL,
	MEMBERNUM NUMBER(6) NOT NULL,
	DISCOUNT NUMBER(4),
	CONSTRAINT RENT_PK PRIMARY KEY (RENT_DATE, IDX), --복합 기본키
	CONSTRAINT RENT_FK1 FOREIGN KEY (BOOKNUM) REFERENCES BOOKLIST(NUM),
	-- RENTLIST의 BOOKNUM은 BOOKLIST 테이블의 BOOKNUM을 참조한다.
	CONSTRAINT RENT_FK2 FOREIGN KEY (MEMBERNUM) REFERENCES MEMBERLIST(NUM)
)
